...
There are different ways to initiate a meeting from the dashboard, depending on how the time is selected.
...
2. In the **Book a Meeting** pop-up, fill out the details.
    * **Select Assignee:** Choose the organizer and any participants.
    * **Select Template:** Choose a meeting template to pre-fill details.
    * **Event Information:**  Enter the details including **Meeting Title**, **Start Time**, **Duration**, **Units**, **Meeting Type**, and **Message**.
...
## How to Create a Manual Meeting
...
2. In the **Create Manual Meeting** pop-up, fill out the details.
    ...
    * **Event Information:** Enter the details including **Meeting Title**, **Location**, **Start Time**, **Duration**, and **Description**.
