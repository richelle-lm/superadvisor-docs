...
![Key Performance Indicators](../../assets/images/home/kpi.png)
...
These widgets focus on your daily workflow and immediate "To-Do" list.

![Operational Widgets](../../assets/images/home/operational-widgets.png)
...
A personalized feed of action items assigned to you.

It displays only the **Task Name** alongside its corresponding **Date**. The list is ordered based on recent dates.

You need to click on the **Task** to view the details and mark it as complete. To perform bulk edits or reassign tasks to team members, click the **View All** button in the widget header to open the full [**Tasks Page**](../tasks).

## Sales & Growth Widgets

These widgets focus on business development and revenue forecasting.

### Pipeline Overview

A visual funnel chart representing the health of your sales process.

![Pipeline Overview](../../assets/images/home/pipeline-overview.png)

Click the **See All** button to open the [**Opportunities Page**](../opportunities) for detailed pipeline management, including **Gross** vs **Adjusted Revenue** toggles.

## Compliance & Retention Widgets

These widgets focus on service standards and digital experience.

### Client Engagement (Portal Activation)
...
![Client Engagement](../../assets/images/home/client-engagement.png)
...
Clicking the chart redirects to the **Portal Access Page**, where you can bulk-send invitations or troubleshoot login issues.
...
### SuperAdvisor AI Assistant (SuperMode)
...
![AI Assistant](../../assets/images/home/ai-assistant.png)

**Capabilities:**

* **Voice-to-Text:** Dictate meeting summaries that auto-convert into CRM notes.
