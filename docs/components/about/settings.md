...
The **Settings** menu allows you to tailor the **Super Advisor** interface to your personal preferences and workflow requirements. Whether you need to reduce eye strain, view more data rows at once, or focus without distractions, you can configure these options globally for your session.
...
![Switch Theme](../../assets/images/profile/settings-theme.gif)
...
1. Click the **Settings** at the bottom of the navigation sidebar.
2. In the **Settings** pop-up, locate the **Text Size** controls section.
...
![Select Text Size](../../assets/images/profile/settings-text.gif)
...
![Enable Full Screen](../../assets/images/profile/settings-fullscreen.gif)