...
![Manage Custom Views](../assets/images/custom-views/manage-custom-views.gif)
...
![Customize Your Contacts](../assets/images/custom-views/customize-contact-list.gif)
...
![Apply Custom View](../assets/images/custom-views/apply-custom-view.gif)